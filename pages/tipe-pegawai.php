        ...
        <div class="section-body contain-lg">
            ...
            <div class="row">
                <div class=" col-lg-offset-2 col-md-8">
                    ...
                    <td>
                    <input type='hidden' id='kode' value='".@$row['kode_tipepegawai']."'>
...
<script>
    $(".delete").click(function(){
        var kode_tipe = $(this).closest('td').find('#kode').val();
        var keterangan = $(this).closest('td').find('#keterangan').val();
        sweetAlert({
                title: "Warning!",
                text: "Apakah anda yakin akan menghapus tipe '"+keterangan+"' ?",
                type: "warning",
            ...
            function () {
                $.ajax({
                    url: "service.php?action=delete-produk&id="+kode_tipe+"",
                    dataType: "text",
