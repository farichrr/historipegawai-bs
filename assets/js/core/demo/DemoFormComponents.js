(function (namespace, $) {
	...
	p._initDatePicker = function () {
		...
		$('#tanggal-masuk').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd"});
		$('#tanggal-keluar').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd"});
		$('#tanggal-lahir').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd"});
